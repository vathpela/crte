...
/** @file
  Processor or Compiler specific defines and types for RISCV-64.  This is
  temporary, until edk2 has it for real.

  Copyright (c) 2006 - 2019, Intel Corporation. All rights reserved.
  Portions copyright (c) 2008 - 2009, Apple Inc. All rights reserved.<BR>
  Portions copyright (c) 2011 - 2013, ARM Ltd. All rights reserved.<BR>
  Portions copyright 2021 Peter Jones.
...
/**
  ...
  On sane CPU architectures, these two pointer values are the same,
